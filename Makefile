...
PATCHLEVEL = 10
SUBLEVEL = 108
EXTRAVERSION = -SkyDragon-Los-v1.0
NAME = END-OF-LIFE
...
HDK		:= /home/holyangel/android/Toolchains/sdc-a15-4.9.4/
HDK_TC		:= /home/holyangel/android/Toolchains/sdc-a15-4.9.4/bin/
ARCH		:= arm
SUBARCH		:= arm
CROSS_COMPILE	:= $(HDK_TC)arm-cortex_a15-linux-gnueabihf-
...
KBUILD_CFLAGS	+= -O2 $(call cc-disable-warning,maybe-uninitialized,) $(CFLAGS_KERNEL) 
KBUILD_CFLAGS += $(call cc-disable-warning,maybe-uninitialized)
